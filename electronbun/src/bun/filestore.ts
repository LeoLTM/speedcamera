...
// Deferred — Utils.paths is only valid after native wrapper initialises
function getImageDir(): string {
  return path.join(Utils.paths.userData, "images");
}
...
/**
 * Save a PNG from a raw base64 string (no data-URL prefix).
