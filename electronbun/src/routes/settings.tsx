...
function SpeedCameraTab() {
  ...
  const isCosmeticDirty = (values.skinMeasuringLocation ?? "") !== (saved.skinMeasuringLocation ?? "");
  ...
  return (
    <div className="max-w-lg space-y-8">
      ...
      {/* Section 2: Display & Cosmetic Settings */}
      <section className="space-y-4">
        ...
        <div className="flex items-center justify-end pt-2">
          <Button
            ...
            disabled={!isCosmeticDirty || savingCosmetic}
          >
