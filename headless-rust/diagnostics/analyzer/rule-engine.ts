    ...
    findings.push({
      ...
      remediation: {
        ...
        commands: [
          ...
          "# 3. Optimize NetworkManager Wi-Fi AP settings (5GHz, powersave off, no MAC randomization, never-default)",
          "sudo nmcli connection modify 'Speedcamera-Hotspot' 802-11-wireless.powersave 2 802-11-wireless.band a 802-11-wireless.channel 36 802-11-wireless.mac-address-randomization 1 ipv4.never-default yes",
