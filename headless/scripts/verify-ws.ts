console.log("Connecting to WebSocket on ws://127.0.0.1:3099/ws/rpc ...");
...
ws.onopen = () => {
  console.log("[WS] Connected to Speedcamera Headless Daemon!");
...
ws.onmessage = (event) => {
  ...
  if (receivedCameraPush && receivedSettingsResponse && receivedViolationsResponse) {
